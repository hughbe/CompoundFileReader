...
internal struct CompoundFileHeader: CustomDebugStringConvertible {
    ...
    internal init(data: inout DataStream) throws {
        ...
        minorVersion = try data.readUInt16()
        ...
        majorVersion = try data.readUInt16()
        ...
        sectorShift = try data.readUInt16()
        ...
        miniSectorShift = try data.readUInt16()
        ...
        for _ in 1...6 {
            reserved1.append(try data.readUInt8())
        }
        ...
        // implemented.
        transactionSignatureNumber = try data.readUInt32()
        ...
        for _ in 1...109 {
            difat.append(try data.readUInt32())
        }
